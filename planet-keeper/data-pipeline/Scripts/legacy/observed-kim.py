# [legacy] 지금 커밋된 observed_kim_dataset.csv를 만든 원본 스크립트(수정 전).
# 위성(GK2A) 좌표 앵커를 자체 생성 좌표로 바꾼 게 ../observed-kim.py다 - 지금
# 커밋된 데이터/climateThresholds.js를 재현하려면 이 버전을 써야 한다.
# 실행: cd 이 폴더(Scripts/legacy) && python3 observed-gk2a.py && python3 observed-kim.py
#
