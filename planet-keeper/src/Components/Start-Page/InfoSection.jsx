...
const GOAL_STEPS = [
  {
    title: "행성 만들기",
    text: "슬라이더(빙하·바다·구름·대기두께·CO₂)로 행성을 만들면 Physics+AI가 지금 조성의 에너지 상태를 바로 판정합니다. 우연히 이미 지구형 평형이면 바로 성공입니다.",
  },
  {
    title: "1단계 문제 & 아이템",
    text: "공식 계산·상태 판정 문제를 풀고 아이템으로 조성을 실제로 바꿉니다. 그 조성이 평형에 도달하면 몇 도가 되는지(Cold / Earth-like / Warm Stable)를 AI가 판정합니다.",
  },
  {
    title: "2단계 확인",
